...
../../../bin/mask_fa test_hg38.fa ../../../data/human_genomic_background_model_p_0.1.out test_hg38_gkm-masked_h.fa

# Mask human sample sequences using the mouse background model.
../../../bin/mask_fa test_hg38.fa ../../../data/mouse_genomic_background_model_p_0.1.out test_hg38_gkm-masked_m.fa
...
python compare_fa.py  # output: 99.79% match
