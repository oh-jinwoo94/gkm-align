...
../../bin/gkm_align -t 1  -g  masker_models.txt -d /mnt/data0/joh27/genomes/ ${to_align} -W ${c},sequence_model_files.txt -p 50 -o output_files/ -n hg38-mm10_enhancer-model-weighted_${h_model}-${m_model}_c-${c}
