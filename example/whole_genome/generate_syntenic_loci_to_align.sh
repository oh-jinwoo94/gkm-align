...
#axtfile="/mnt/data0/joh27/projects/alignment_enhancer_conservation/gkm_align_input_generation/whole_genome/HSPs/hg38_to_mm10_notransition_step_1_gfextend_nochain_nogapped.axt"
