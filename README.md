...
After generating 'human_mouse_WG_syntenic_intergenic_loci.to_align' (uploaded [here](examples/whole_genome)) through the pipeline described above, whole-genome alignment can now be performed by running:
<pre>
bash run_gkmalign.sh
</pre>
